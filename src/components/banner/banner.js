      ...
      <div className="">
        <div className="">
          <div className="relative">
            ...
            />
            <Image
              className="xs:top-2 xs:right-24 absolute right-20 top-1 w-1/3 md:right-40 lg:right-52 xl:right-64"
              width={892}
              height={712}
              alt="isunone"
              ...
              contain="true"
            />
            <div className="xxs:left-20 xxs:mt-7 xxs:text-sm xs:left-28 xs:mt-10 xs:text-base absolute left-16 top-0 mt-5 flex text-xs sm:left-36 sm:top-3 sm:text-xl md:left-40 md:top-5 md:mt-12 md:text-3xl lg:top-5 lg:left-52 lg:mt-16 lg:text-4xl xl:top-5 xl:left-56 xl:text-5xl 2xl:left-96 2xl:top-20 2xl:text-6xl">
