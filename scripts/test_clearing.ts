...
// Info: (20260223 - Tzuhan) 初始化客戶端 (使用環境變數中的私鑰作為 Admin 測試者)
...
async function main() {
  ...
  // ==========================================
  // Info: (20260223 - Tzuhan) 📍 步驟 0：確保 Admin 具備合規 Identity
  // ==========================================
  ...
  // ==========================================
  // Info: (20260223 - Tzuhan) 📍 測試 B：自動還款 (有負債時收到錢自動沖銷)
  // ==========================================
  console.log('\n=============================================');
  console.log('▶️ 測試 B：Admin 獲得資金，系統自動沖銷負債');
  console.log('=============================================');
  
  // Info: (20260223 - Tzuhan) 1. 我們先印鈔 50 NTD 給 Admin，模擬 Admin 從外部入金或收到匯款
  ...
  // Info: (20260223 - Tzuhan) 2. 觸發自動清算：只要 Admin 再次成為 `settlementTransfer` 的接收方，就會觸發沖銷。
  // Info: (20260223 - Tzuhan) 我們可以讓 Admin 發起一筆「自己轉給自己 0.001 NTD」的微小交易來當作觸發器。
