...
const Toast = ({title = 'Notification', content = 'Signature hash: ', time: mins = '2'}) => {
  ...
  const isDisplayedToast = showToast && (
    <div className="flex justify-center space-x-2">
      <div
        className="pointer-events-auto mx-auto mr-2 mt-2 block w-72 max-w-full rounded-lg bg-white bg-clip-padding text-sm shadow-md shadow-cuteBlue/70 outline-none focus:outline-none"
        id="static-example"
        role="alert"
        aria-live="assertive"
        aria-atomic="true"
