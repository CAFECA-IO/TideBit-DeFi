...
const BadgeModal = ({modalVisible, modalClickHandler, badgeData}: IBadgeModalProps) => {
  ...
  const isDisplayedModal = modalVisible ? (
    ...
    <div className="fixed inset-0 z-80 flex items-center justify-center overflow-y-auto overflow-x-hidden bg-black/25 outline-none backdrop-blur-sm focus:outline-none">
      <div
        id="BadgeModal"
        className="relative flex h-auto w-9/10 flex-col space-y-4 rounded-xl py-6 bg-darkGray1 shadow-lg shadow-black/80 outline-none focus:outline-none sm:w-450px"
      >
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="absolute right-5 top-5 border-0 bg-transparent p-1 text-base font-semibold leading-none text-gray-300 outline-none focus:outline-none"
          >
            <ImCross />
          </button>
        </div>
