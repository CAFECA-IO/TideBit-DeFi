...
export const dummyWeeklyLeaderboard: ILeaderboard[] = [
  ...
  {rank: 6, userName: 'Larry', userAvatar: '/leaderboard/dummy_avatar_4.svg', cumulativePnl: 17.33},
...
export const getDummyLeaderboard = (timeSpan: IRankingTimeSpan) => {
  let result = [defaultLeaderboard, defaultLeaderboard, defaultLeaderboard];
  switch (timeSpan) {
