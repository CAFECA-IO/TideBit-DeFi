...
const PositionTabMobile = () => {
  ...
  const subMenu = (
    <div
      className={`flex w-screen justify-center bg-darkGray ${
        openSubMenu ? 'translate-y-0' : 'translate-y-0'
      } absolute left-0 bottom-16 overflow-hidden transition-all duration-300`}
    >
      {currentSubTab}
    </div>
  );
