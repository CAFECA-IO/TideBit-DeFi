		...
		<section className={`text-gray-400 bg-black body-font py-24`}>
			<div className="container mx-auto flex px-5 pb-24 md:flex-row items-center flex-wrap space-y-2">
				<div className="mx-auto lg:max-w-lg lg:w-full md:w-1/2 w-5/6 md:mb-0 mb-10">
					...
					<div className="flex flex-wrap space-y-1 md:ml-auto md:mr-0 mx-auto items-center justify-center flex-shrink-0 sm:space-x-4 mt-5">
						<button className="border-2 border-slate-200 bg-black inline-flex py-3 px-5 rounded-xl items-center hover:bg-gray-700 hover:bg-opacity-50 focus:outline-none">
							...
							<span className="xl:ml-4 flex items-start flex-col leading-none">
