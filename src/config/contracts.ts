...
export const CONTRACT_ADDRESSES = {
  ...
  FACTORY: (process.env.NEXT_PUBLIC_SCW_FACTORY_ADDRESS ||
    '0x5649bA806AAEea33c4004aa99fBFCF5813b1626c') as Address,
  NTD_TOKEN:
    process.env.NEXT_PUBLIC_NTD_TOKEN_ADDRESS ||
    ('0xfe774301b860D13069f97767Bd16B0D9e05bd97B' as Address),
  IDENTITY_REGISTRY:
    process.env.NEXT_PUBLIC_IDENTITY_REGISTRY_ADDRESS ||
    ('0x4c35a41B7882c2190534Bbb02c42C7F07B06d9d6' as Address),
} as const;
